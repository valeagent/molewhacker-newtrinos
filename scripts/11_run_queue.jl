...
# =============================================================================
#
#   julia --project=. -t 4 scripts/11_run_queue.jl queue_A.txt [--out DIR] [--tmax N]
#
...
# --out / --tmax apply to every cell of the queue (ablation runs).
include(joinpath(@__DIR__, "10_run_cell.jl"))

function run_queue(path; out = joinpath(@__DIR__, "..", "out"), tmax = nothing)
...
if abspath(PROGRAM_FILE) == @__FILE__
    io = findfirst(==("--out"), ARGS); it = findfirst(==("--tmax"), ARGS)

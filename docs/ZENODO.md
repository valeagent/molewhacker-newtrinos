...
**Record:** `10.5281/zenodo.XXXXXXXX` (to be inserted after publication)
...
| `molewhacker-newtrinos-ablation.tar` (6.5 GB, as four parts `.part-00` ... `.part-03`) | the six MW cells with the iteration cap lifted, with the full per-iteration history | `out_ablation/runs/` |
...
```sh
cat molewhacker-newtrinos-ablation.tar.part-* > molewhacker-newtrinos-ablation.tar   # Windows: copy /b part-00+part-01+part-02+part-03 ...
